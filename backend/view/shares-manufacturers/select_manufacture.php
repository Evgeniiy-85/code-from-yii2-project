...
<div class="box box-primary box-solid">
  ...
  <div class="box-body row">
    ...
    ->dropDownList([], [
      ...
      'data-mnf_section' => implode(',', array_merge(
          Yii::$app->params['sections_opt'],
          Yii::$app->params['sections_furnitura'],
          Yii::$app->params['sections_furnitura_retail'],
          Yii::$app->params['sections_furnitura_opt']
        )
      ),
    ]) ?>
  </div>
